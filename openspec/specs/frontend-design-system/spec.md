...
## Purpose
Define the centralized frontend design foundation and reusable UI patterns so all application sections share consistent, trustworthy, and approachable visual behavior.

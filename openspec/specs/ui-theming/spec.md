...
## Purpose
Define token-driven theming behavior for application UI so light and dark modes remain consistent, predictable, and free of route-specific visual overrides.
